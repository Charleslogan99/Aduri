...
const Mission = () => {
  return (
    <div className="container mx-auto pb-16 mb-16 px-4 py-8">
      <div className='p-8'>
        <h1 className='font-semibold text-4xl text-blue-700 text-center'>Our Major Causes</h1>
        <p className='text-sm pt-4 text-black text-center'>Our organization is committed to addressing the diverse needs of women and children worldwide. Through our initiatives, we strive to create a safe, nurturing, and empowering environment where every woman and child can thrive and reach their full potential.</p>
      </div>
