        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="text-white">
            ...
            {/* <p className="text-blue-700 text-md">ADURI-EL-SHADDAI-FOUNDATION</p> */}
                <p className='text-blue-700 text-xs'>lorem ipsum dolor machkatib djjsk yruxnn lorem ipsum dolor machkatib djjsk yruxnnlorem ipsum dolor machkatib djjsk yruxnnlorem ipsum dolor machkatib djjsk yruxnnlorem ipsum dolor machkatib djjsk yruxnn</p>
          </div>
          ...
          <div className="text-white xl:ml-20">
            ...
            <ul className='flex flex-col'>
              ...
              <a href='/contact' className="text-blue-700">Contact</a>
              <a href='/projects' className="text-blue-700">Projects</a>
              <a href='/faq' className="text-blue-700">Faq</a>
              {/* Add more programs */}
            </ul>
          </div>
