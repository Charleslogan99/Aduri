        ...
        <div className="container mx-auto px-4 py-8 mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center transition duration-300 ease-in-out transform hover:scale-105">
                    ...
                    <p className="text-sm font-semibold text-blue-700 mt-6">Provide Lifeline through Donations</p>
                    <p className='text-xs text-center mt-1'>Your generous donations fuel our mission to provide essential resources and support to those in need. Together, we can make a significant difference in the lives of vulnerable communities. Every contribution counts towards creating a brighter future for all.</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center transition duration-300 ease-in-out transform hover:scale-105">
                    ...
                    <p className="text-sm font-semibold text-blue-700 mt-6">Inspiring Change and Empowerment</p>
                    <p className='text-xs text-center mt-1'>We believe in the power of inspiration to drive positive change. Through our initiatives, we aim to ignite hope, creativity, and innovation within communities. Together, let's foster a culture of empowerment and resilience that transcends boundaries and transforms lives.</p>
                </div>
            </div>
        </div>
    );
