        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8">
            ...
            <p className="text-blue-700 mb-2">
              Our office is located at X14b Patrick Fluret, Sunnyvale Homes, Abuja, Nigeria.
            </p>
            ...
            <ol className="list-decimal text-gray-600 pl-4">
              ...
              <li>From the National Mosque, head towards Wuse Market.</li>
              <li>Pass by Sheraton Hotel on your right.</li>
              <li>Continue straight until you reach Sunnyvale Homes.</li>
              <li>Our office (X14b Patrick Fluret) is located within Sunnyvale Homes.</li>
            </ol>
          </div>
          <div className="mt-8">
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Nearby Locations</h3>
            {/* <p className="text-gray-600 mb-2">To get here:</p> */}
            <ol className="list-decimal text-gray-600">
           <p className="text-blue-700">
              <MdLocationOn className="inline-block mr-2" />Kabusa garden estate
            </p>
           <p className="text-blue-700">
              <MdLocationOn className="inline-block mr-2" />Sun city estate
            </p>
